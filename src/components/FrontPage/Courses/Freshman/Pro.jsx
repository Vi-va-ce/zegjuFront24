  ...
  return (
    <div className='bg-[#eadfff] w-[166px] md:w-[264px] h-[250px] md:h-[398px] rounded-md'>
      ...
      <div className='flex justify-center items-center pt-1 md:pt-6'>
        <div className=''>
          <div>
            <button className='bg-gradient-to-r from-[#c23fcd] to-[#966ded] hover:opacity-80 transition-opacity duration-300 text-white hover:text-black w-[141px] md:w-[224px] h-[24px] md:h-[38px] rounded-md ' onClick={handleClick}>
